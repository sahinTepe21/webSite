      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-light text-gray-900 mb-6 leading-relaxed">
              2010 yılından beri metrekarelerle değil santimetrekarelerle
              çalışarak, ince düşünülmüş yaşam alanları tasarlıyoruz.
            </h2>
            <Link to="/hakkimizda">
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-4xl md:text-5xl font-light text-gray-400">
                  |
                </span>
                <h2 className="text-4xl md:text-5xl font-light text-gray-900">
                  ARSA
            ...
            <Link to="/projeler?category=arsa">
